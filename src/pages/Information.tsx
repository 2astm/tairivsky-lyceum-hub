          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center animate-fade-up">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Дізнайтеся більше про наш навчальний заклад, його історію, місію та цінності.
              </p>
            </div>
          </div>
        </BackgroundGradient>
            ...
            <div className="mt-12 space-y-12">
              {[
                ...
                },
                {
                  year: '2015',
                  title: 'Статус ліцею',
                  description: 'Навчальний заклад отримав статус ліцею та розширив освітню програму, додавши профільне навчання та поглиблене вивчення предметів.'
                },
                {
                  year: '2020',
                  title: 'Сучасність',
