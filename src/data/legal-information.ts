...
export const legalSections = [
    {
        ...
        icon: FileText,
        content: "Оголошення про проведення конкурсу на заміщення вакантної посади директора Таїрівського ліцею Таїрівської селищної ради Одеського району Одеської області",
        documents: [
            {
    ...
    },
    {
        ...
        title: 'Статут ліцею',
        icon: FileText,
        content: "Статут Таїрівського ліцею Таїрівської селищної ради Одеського району Одеської області",
        documents: [
            {
                label: 'Статут (PDF)',
    ...
    },
    {
        ...
        categories: ['administrative'],
        title: 'Стратегія розвитку Таїрівського ліцею',
        icon: FileText,
        content: "Стратегія розвитку Таїрівського ліцею на 2025 - 2030 роки. Документ визначає основні напрямки розвитку закладу, цілі та завдання на найближчі роки.",
        documents: [
            {
    ...
    },
    {
        id: 'oblik-ditej',
        categories: ['administrative'],
        title: 'Територія обслуговування Таїрівського ліцею',
        icon: FileText,
        content: "Територія обслуговування Таїрівського ліцею",
        documents: [
            {
    ...
    },
    {
        ...
        icon: FileText,
        content: `З <b>02 березня по 29 травня 2026 року</b> буде здійснюватися прийом документів для вступу дітей до <b>1-го класу</b> Таїрівського ліцею Таїрівської селищної ради Одеського району Одеської області`,
        documents: [
            {
