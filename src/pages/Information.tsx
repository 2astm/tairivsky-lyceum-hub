              ...
              {[
                {
                  year: '1980',
                  title: 'Заснування',
                  description: 'Таїрівський ліцей був заснований як загальноосвітня школа для забезпечення якісною освітою дітей місцевої громади.'
                },
                {
                  year: '1995',
                  title: 'Реорганізація',
                ...
                },
                {
                  year: '2020',
                  title: 'Сучасність',
                  description: 'Сьогодні Таїрівський ліцей - це сучасний освітній заклад, який поєднує традиції та інновації, забезпечуючи всебічний розвиток учнів.'
                }
              ].map((item, index) => (
